...
impl IoWrite for Writer {
    fn write(&mut self, buf: &[u8]) -> usize {
        let rcc = stm32f412rg::rcc::Rcc::new();
        let clocks: stm32f412rg::clocks::Clocks<Stm32f412Specs> =
            stm32f412rg::clocks::Clocks::new(&rcc);
        let uart = stm32f412rg::usart::Usart::new_usart1(&clocks);
...
pub unsafe fn panic_fmt(info: &PanicInfo) -> ! {
    ...
    let clocks: stm32f412rg::clocks::Clocks<Stm32f412Specs> =
        stm32f412rg::clocks::Clocks::new(&rcc);
    let syscfg = stm32f412rg::syscfg::Syscfg::new(&clocks);
    let exti = stm32f412rg::exti::Exti::new(&syscfg);
    let pin = stm32f412rg::gpio::Pin::new(PinId::PE02, &exti);
    let gpio_ports = stm32f412rg::gpio::GpioPorts::new(&clocks, &exti);
