...
pub use stm32f4xx::{
    adc, can, chip, clocks, dbg, dma, exti, flash, fsmc, gpio, i2c, nvic, rcc, spi, syscfg, tim2,
    trng, usart,
};
...
pub static IRQS: [unsafe extern "C" fn(); 97] = [
    ...
    CortexM4F::GENERIC_ISR, // unused
    CortexM4F::GENERIC_ISR, // unused
    CortexM4F::GENERIC_ISR, // Quad-SPI (92)
    CortexM4F::GENERIC_ISR, // unused
    CortexM4F::GENERIC_ISR, // unused
